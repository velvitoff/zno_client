// Animation was copied from https://pub.dev/packages/loading_animation_widget

import 'package:client/widgets/hexagon_dots/build_dot.dart';
...
class HexagonDotsLoading extends StatefulWidget {
  ...
  factory HexagonDotsLoading.def() {
    return HexagonDotsLoading(
        size: 150.r, color: const Color.fromARGB(255, 68, 154, 78));
  }

  factory HexagonDotsLoading.size(double size) {
    return HexagonDotsLoading(
        size: size, color: const Color.fromARGB(255, 68, 154, 78));
  }

  @override
  BuildSpinnerState createState() => BuildSpinnerState();
}

class BuildSpinnerState extends State<HexagonDotsLoading>
