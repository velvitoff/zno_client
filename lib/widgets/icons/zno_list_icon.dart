...
class ZnoListIcon extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint0Fill.color = const Color(0xffF4F4F4);
    ...
    paint1Fill.color = const Color(0xffF4F4F4);
    ...
    paint2Fill.color = const Color(0xffF4F4F4);
    ...
    paint3Fill.color = const Color(0xffF4F4F4);
