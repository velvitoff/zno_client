...
class PrevAttemptItem extends StatelessWidget {
  final PreviousAttemptModel data;
  final bool detailed;

  const PrevAttemptItem({Key? key, required this.data, this.detailed = false})
      : super(key: key);
  ...
  Future<void> _onRestoreAttempt(BuildContext context) async {
    ...
    context.read<SessionRouteStateModel>().onRestoreAttempt(context, data);
  }
